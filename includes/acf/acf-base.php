...
acf_add_local_field_group(  [
    ...
    'fields' => [
        ...
        [
            'key' => 'field_draad_az_text_number_tab_base',
            'label' => __( 'Tekstnummer - versie 1 van de adreszoeker', 'draad-az' ),
            'name' => '',
            'aria-label' => '',
            'type' => 'tab',
            'instructions' => '',
        ...
        [
            ...
            'label' => __( 'Tekst nummer', 'draad-az' ),
        ...
        [
            ...
            'label' => __( 'Tekstnummer - versie 3 van de adreszoeker', 'draad-az' ),
            'name' => '',
            'aria-label' => '',
            'type' => 'tab',
            'instructions' => '',
        ...
        [
            ...
            'label' => __( 'Tekst nummer voor de 3e versie van de adreszoeker', 'draad-az' ),
