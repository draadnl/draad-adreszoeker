            ...
            'sub_fields' => [
                ...
                [
                    ...
                    'sub_fields' => [
                        ...
                        [
                            'key' => 'subfield_draad_az_period_subsidies_tiles',
                            'label' => 'Tegels',
                            'name' => 'tiles',
                            'aria-label' => '',
                            'type' => 'repeater',
                            ...
                            'sub_fields' => [
                                [
                                    'key' => 'subfield_draad_az_period_subsidies_tiles_post',
                                    'label' => 'Post',
                                    'name' => 'post',
                                    'aria-label' => '',
                                    'type' => 'post_object',
                                    ...
                                    'ui' => 1,
                                    'bidirectional_target' => [],
                                    'parent_repeater' => 'subfield_draad_az_period_subsidies_tiles',
                                ],
                                [
                                    'key' => 'subfield_draad_az_period_subsidies_tiles_label',
                                    'label' => 'Label',
                                    'name' => 'label',
                                    'aria-label' => '',
                                    'type' => 'text',
                        ...
                        [
                            'key' => 'subfield_draad_az_period_subsidies_button',
                            'label' => 'Knop',
                            'name' => 'button',
                            'aria-label' => '',
                            'type' => 'link',
                            'instructions' => 'Deze knop wordt weergeven onder de tegels.',
                            'required' => 0,
                            'conditional_logic' => 0,
                            'wrapper' => [
                                'width' => '',
