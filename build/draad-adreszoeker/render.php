	...
	<form action="post">
		<search class="draad-adreszoeker__filters">
			<div class="draad-adreszoeker__filter --street">
				<label for="street"><?php esc_html_e('Straatnaam', 'draad-adreszoeker') ?></label>
				<input list="street-list" id="street" name="street" placeholder="<?php esc_attr_e('Vul uw straatnaam in.', 'draad-adreszoeker') ?>" autocomplete="off" required aria-required="true">
				<datalist id="street-list" class="draad-adreszoeker__suggestions"></datalist>
			</div>
	
			<div class="draad-adreszoeker__filter --number">
				<label for="huisnummer"><?php esc_html_e('Huisnummer (zonder toevoeging)', 'draad-adreszoeker') ?></label>
