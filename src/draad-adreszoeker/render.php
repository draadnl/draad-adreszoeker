	...
	<form action="post">
		<search class="draad-adreszoeker__filters">
			<div class="draad-adreszoeker__filter --street">
				...
				<input list="street-list" id="street" name="street" placeholder="<?php esc_attr_e('Vul uw straatnaam in.', 'draad-az') ?>" autocomplete="off" required aria-required="true">
			...
			<div class="draad-adreszoeker__filter --number">
				...
				<input type="number" id="huisnummer" name="housenumber" placeholder="<?php esc_attr_e('Vul uw huisnummer in.', 'draad-az') ?>" max="9999" disabled required aria-required="true">
			</div>
